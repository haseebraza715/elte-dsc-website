      ...
      <div className="section-container relative z-10">
        ...
        <div className="max-w-3xl mb-16">
          <div className="section-label mb-4">
            <span className="w-8 h-px bg-[#6366F1]"></span>
            <span>Get in Touch</span>
          </div>
          <h2 className="text-4xl sm:text-5xl font-display font-bold text-[#FAFAFA] mb-6">
        ...
        {/* Main CTA Card */}
        <div className="relative mb-8 rounded-2xl p-px bg-gradient-to-r from-[#6366F1]/40 via-[#6366F1]/10 to-[#6366F1]/40">
          <div className="absolute inset-0 rounded-2xl bg-[#6366F1]/5 blur-xl pointer-events-none"></div>
        ...
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {/* Email Card */}
          <div className="glass-card p-6 flex flex-col items-center text-center space-y-4 group hover:border-white/10 transition-all duration-300">
            <div className="w-10 h-10 rounded-lg bg-[#6366F1]/10 border border-[#6366F1]/20 flex items-center justify-center text-[#6366F1] transition-all duration-300">
            ...
            <div>
              ...
              <a href="mailto:ot7dee@inf.elte.hu" className="text-white font-semibold text-sm hover:text-[#818CF8] transition-colors break-all">
                ot7dee@inf.elte.hu
              </a>
            </div>
          </div>
          ...
          <div className="glass-card p-6 flex flex-col items-center text-center space-y-4 group hover:border-white/10 transition-all duration-300">
            ...
            <div>
              ...
              <div className="text-white font-semibold text-sm">ELTE South Building Room 0-817</div>
            </div>
          </div>
          ...
          <div className="glass-card p-6 flex flex-col items-center text-center space-y-4 group hover:border-white/10 transition-all duration-300">
            ...
            <div>
              <div className="text-xs font-bold text-white/40 uppercase tracking-widest mb-1">Meeting Time</div>
              <div className="text-white font-semibold text-sm">4:00-5:30 PM Room 0.817</div>
            </div>
          </div>
        </div>
      </div>
