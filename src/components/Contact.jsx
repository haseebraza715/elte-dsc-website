  ...
  return (
    <section id="contact" className="relative py-24 sm:py-32 overflow-hidden bg-bg-base">
      <div className="section-container relative z-10">
        ...
        {/* Main CTA Card */}
        <div className="relative mb-8 rounded-2xl p-px bg-gradient-to-r from-accent/40 via-accent/10 to-accent/40">
        ...
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {/* Email Card */}
          <div className="glass-card p-6 flex flex-col items-center text-center space-y-4 group hover:border-border-glass transition-all duration-300">
