export default function Contact() {
  return (
    <section id="contact" className="relative py-20 md:py-28 lg:py-32 bg-[#09090b] overflow-hidden">
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 z-10">
        ...
        <div className="text-center mb-12 md:mb-16">
          <div className="inline-flex items-center gap-2 rounded-full border border-zinc-700 bg-zinc-800/80 backdrop-blur-sm px-4 py-2 text-sm font-semibold text-emerald-400 shadow-sm mb-6">
        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-stretch">
          {/* Join Club Section */}
          <div className="relative bg-[#1E293B] backdrop-blur-xl rounded-2xl p-8 lg:p-10 shadow-xl shadow-black/20 hover:shadow-2xl hover:shadow-violet-500/10 transition-all duration-300 border border-zinc-700/50">
            <div className="absolute inset-0 bg-gradient-to-br from-violet-600/5 via-transparent to-emerald-600/5 rounded-2xl pointer-events-none"></div>
            <div className="relative z-10">
              <div className="flex items-center mb-6">
                <div className="w-12 h-12 bg-gradient-to-br from-violet-600 to-emerald-600 rounded-xl flex items-center justify-center mr-4 shadow-lg shadow-violet-500/20">
                ...
                <div>
                  ...
                  <p className="text-zinc-400 text-sm md:text-base">Become a member today</p>
                </div>
              </div>
              ...
              <a
                ...
                className="group relative w-full bg-gradient-to-r from-violet-600 to-emerald-600 hover:from-violet-500 hover:to-emerald-500 text-white px-8 py-4 rounded-xl font-semibold text-base md:text-lg transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-violet-500 focus:ring-offset-2 focus:ring-offset-zinc-900 hover:shadow-xl hover:shadow-violet-500/25 hover:-translate-y-0.5 active:translate-y-0 flex items-center justify-center overflow-hidden"
              >
          ...
          {/* Contact Section */}
          <div className="relative bg-[#1E293B] backdrop-blur-xl rounded-2xl p-8 lg:p-10 shadow-xl shadow-black/20 hover:shadow-2xl hover:shadow-violet-500/10 transition-all duration-300 border border-zinc-700/50">
            <div className="absolute inset-0 bg-gradient-to-br from-emerald-600/5 via-transparent to-violet-600/5 rounded-2xl pointer-events-none"></div>
            <div className="relative z-10">
              <div className="flex items-center mb-6">
                <div className="w-12 h-12 bg-gradient-to-br from-emerald-600 to-violet-600 rounded-xl flex items-center justify-center mr-4 shadow-lg shadow-emerald-500/20">
                  <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 4.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                  </svg>
                </div>
                <div>
                  ...
                  <p className="text-zinc-400 text-sm md:text-base">We'd love to hear from you</p>
                </div>
              </div>
              ...
              <div className="space-y-4">
                <div className="group flex items-start p-5 bg-zinc-800/50 backdrop-blur-sm hover:bg-zinc-700/50 rounded-xl border border-zinc-700/50 hover:border-violet-500/30 transition-all duration-300 hover:shadow-md hover:-translate-x-1">
                  <div className="w-11 h-11 bg-gradient-to-br from-violet-600 to-emerald-600 rounded-lg flex items-center justify-center mr-4 flex-shrink-0 shadow-md shadow-violet-500/20 group-hover:scale-110 transition-transform duration-300">
                  ...
                  <div className="pt-1">
                    ...
                    <a
                      ...
                      className="text-emerald-400 hover:text-emerald-300 font-medium text-sm md:text-base transition-colors duration-200"
                    >
                      ot7dee@inf.elte.hu
                    </a>
                  </div>
                ...
                <div className="group flex items-start p-5 bg-zinc-800/50 backdrop-blur-sm hover:bg-zinc-700/50 rounded-xl border border-zinc-700/50 hover:border-violet-500/30 transition-all duration-300 hover:shadow-md hover:-translate-x-1">
                  ...
                  <div className="pt-1">
                    ...
                    <div className="text-zinc-400 text-sm md:text-base">Eötvös Loránd University</div>
                    <div className="text-zinc-400 text-sm md:text-base">Room 0.825, South Building</div>
                  </div>
                </div>
                ...
                <div className="group flex items-start p-5 bg-zinc-800/50 backdrop-blur-sm hover:bg-zinc-700/50 rounded-xl border border-zinc-700/50 hover:border-violet-500/30 transition-all duration-300 hover:shadow-md hover:-translate-x-1">
                  ...
                  <div className="pt-1">
                    ...
                    <div className="text-zinc-400 text-sm md:text-base">Fridays, 4:00 PM - 5:00 PM</div>
                  </div>
                </div>
              </div>
            </div>
