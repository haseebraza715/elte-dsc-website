  ...
  return (
    ...
    >
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute inset-y-0 left-1/2 -translate-x-1/2 w-[95%] max-w-6xl rounded-[60px] bg-gradient-to-r from-violet-500/10 via-fuchsia-500/5 to-emerald-500/10 blur-3xl opacity-50" />
        <div className="absolute -top-56 -left-40 w-[520px] h-[520px] bg-gradient-to-br from-violet-600/20 via-fuchsia-600/15 to-rose-600/10 rounded-full blur-3xl animate-[pulse_9s_ease-in-out_infinite]" />
        <div className="absolute -bottom-52 -right-32 w-[560px] h-[560px] bg-gradient-to-bl from-emerald-600/20 via-teal-600/15 to-violet-600/10 rounded-full blur-3xl animate-[pulse_11s_ease-in-out_infinite]" />
        ...
        <div className="min-h-[70vh] flex flex-col 2xl:flex-row items-center justify-between gap-12 2xl:gap-20 py-10 sm:py-16 md:py-20">
          <div className="w-full 2xl:w-[55%] text-center 2xl:text-left space-y-6">
            <div className="space-y-3">
              <div className="inline-flex items-center rounded-full border border-white/10 bg-zinc-800/50 backdrop-blur-sm px-6 py-1.5 text-[11px] font-semibold uppercase tracking-[0.35em] text-emerald-400 shadow-sm shadow-emerald-500/10">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 items-center justify-center 2xl:justify-start w-full">
              ...
              <button
                ...
                className="inline-flex w-full sm:w-auto items-center justify-center gap-2 rounded-2xl border border-zinc-700 px-8 py-4 text-base font-semibold text-emerald-300 bg-zinc-800/50 backdrop-blur-sm transition hover:text-white hover:border-emerald-500/50 hover:bg-zinc-800 focus:outline-none focus:ring-2 focus:ring-emerald-400 focus:ring-offset-2 focus:ring-offset-[#09090b]"
              >
            ...
            <div className="mt-6 grid grid-cols-1 sm:grid-cols-3 gap-4 text-zinc-300">
              <div className="rounded-3xl bg-[#18181b]/80 border border-zinc-700/50 p-5 shadow-lg shadow-black/20 border-l-4 border-l-violet-500 text-left flex flex-col gap-1.5 backdrop-blur-sm">
              ...
              <div className="rounded-3xl bg-[#18181b]/80 border border-zinc-700/50 p-5 shadow-lg shadow-black/20 border-l-4 border-l-fuchsia-500 text-left flex flex-col gap-1.5 backdrop-blur-sm">
                ...
                <p className="text-sm text-zinc-400">Projects this semester</p>
              </div>
              <div className="rounded-3xl bg-[#18181b]/80 border border-zinc-700/50 p-5 shadow-lg shadow-black/20 border-l-4 border-l-emerald-500 text-left flex flex-col gap-1.5 backdrop-blur-sm">
                ...
                <p className="text-sm text-zinc-400">Talks & workshops</p>
              </div>
            </div>
          ...
          <div className="flex-[1.1] w-full max-w-3xl mx-auto flex flex-col gap-4 sm:gap-5">
            {/* Next meetup section removed as per request */}
            <div className="relative rounded-[36px] overflow-hidden bg-zinc-800/80 backdrop-blur-md border border-zinc-700/50 shadow-2xl shadow-black/30 aspect-[4/3] sm:aspect-[5/3] min-h-[260px] sm:min-h-[360px] w-full">
              <div className="absolute inset-4 rounded-[30px] border border-white/30 pointer-events-none" />
              <div className="absolute inset-0 overflow-hidden rounded-[36px] bg-zinc-800">
                <div
              ...
              <button
                type="button"
                onClick={goToPrev}
                className="hidden sm:flex absolute left-5 top-1/2 -translate-y-1/2 rounded-full bg-zinc-900/80 text-white p-2 shadow-md shadow-black/20 border border-zinc-700 hover:bg-zinc-800"
              ...
              <button
                type="button"
                onClick={goToNext}
                className="hidden sm:flex absolute right-5 top-1/2 -translate-y-1/2 rounded-full bg-zinc-900/80 text-white p-2 shadow-md shadow-black/20 border border-zinc-700 hover:bg-zinc-800"
