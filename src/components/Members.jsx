      ...
      <div className="bg-white rounded-xl md:rounded-2xl p-3 sm:p-5 md:p-6 h-full flex flex-col border border-slate-200/60 shadow-sm hover:shadow-xl hover:shadow-sky-500/10 transition-all duration-200 hover:-translate-y-1 md:hover:-translate-y-2 overflow-hidden">
        ...
        <div className="flex flex-col items-center text-center relative z-10">
          ...
          <div className="relative mb-3 sm:mb-5 w-full">
            <div className="relative w-full aspect-square rounded-lg md:rounded-xl overflow-hidden bg-gradient-to-br from-sky-500 to-blue-600 shadow-md md:shadow-lg group-hover:shadow-xl group-hover:scale-[1.01] md:group-hover:scale-[1.02] transition-all duration-200">
              {imageSrc && !imageError ? (
                <>
          ...
          {/* Meta Info */}
          {person.meta && (
            <div className="flex items-center justify-center mb-2 sm:mb-2.5 text-slate-600">
          ...
          {/* Description */}
          {person.description ? (
            <div className="mb-3 sm:mb-4 md:mb-5 text-center w-full">
              <div className="flex items-center justify-center px-3 sm:px-4">
                <svg className="w-3.5 h-3.5 sm:w-4 sm:h-4 md:w-4 md:h-4 mr-1.5 text-sky-500 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 13.255A23.931 23.931 0 0112 15c-3.183 0-6.22-.62-9-1.745M16 6V4a2 2 0 00-2-2h-4a2 2 0 00-2 2v2m4 6h.01M5 20h14a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                <p className="text-xs sm:text-sm md:text-base text-slate-700 leading-relaxed font-semibold">
                  {person.description}
                </p>
              </div>
            </div>
          ...
          {/* Social Links */}
          <div className="mt-auto w-full flex justify-center items-center gap-3 sm:gap-4">
            {/* LinkedIn Link */}
            {person.link && (
              <a
                href={person.link}
                ...
                className="group/link inline-flex items-center justify-center p-2 sm:p-2.5 rounded-lg text-sky-600 hover:text-sky-700 hover:bg-sky-50 transition-all duration-200"
                aria-label="LinkedIn Profile"
              >
                <svg className="w-5 h-5 sm:w-6 sm:h-6 md:w-6 md:h-6 transition-transform duration-200 group-hover/link:scale-110" fill="currentColor" viewBox="0 0 24 24">
            ...
            {person.email && (
              <a
                ...
                className="group/email inline-flex items-center justify-center p-2 sm:p-2.5 rounded-lg text-sky-600 hover:text-sky-700 hover:bg-sky-50 transition-all duration-200"
                aria-label={`Email ${person.name}`}
                title={`Email: ${person.email}`}
              >
                <svg className="w-5 h-5 sm:w-6 sm:h-6 md:w-6 md:h-6 transition-transform duration-200 group-hover/email:scale-110" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
