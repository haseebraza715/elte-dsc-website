    ...
    <>
      ...
      <main className="relative min-h-screen bg-[#09090b] overflow-hidden">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none" style={{ willChange: 'auto', transform: 'translate3d(0, 0, 0)' }}>
          <div className="absolute -top-48 -left-48 w-[500px] h-[500px] md:w-[700px] md:h-[700px] bg-gradient-to-br from-violet-600/20 via-purple-600/15 to-fuchsia-600/10 rounded-full mix-blend-screen filter blur-2xl md:blur-3xl opacity-50" style={{ transform: 'translate3d(0, 0, 0)' }} />
          <div className="absolute -top-48 -right-48 w-[500px] h-[500px] md:w-[700px] md:h-[700px] bg-gradient-to-bl from-emerald-600/20 via-emerald-600/15 to-violet-600/10 rounded-full mix-blend-screen filter blur-2xl md:blur-3xl opacity-50" style={{ transform: 'translate3d(0, 0, 0)' }} />

          <div className="absolute inset-0 bg-gradient-to-b from-transparent via-transparent to-[#09090b] opacity-80" style={{ transform: 'translate3d(0, 0, 0)' }} />
        </div>
        ...
        <div className="relative z-10">
            ...
            <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
              <div className="text-center mb-20">
                <div className="inline-block mb-6">
                  <span className="inline-flex items-center px-4 py-2 bg-zinc-800/80 text-emerald-400 rounded-full text-sm font-semibold border border-zinc-700 backdrop-blur-sm">
                ...
                <div className="mt-8 flex items-center justify-center gap-6 text-zinc-400">
                  <div className="flex items-center gap-2">
                    <div className="w-2 h-2 rounded-full bg-emerald-400 shadow-[0_0_8px_rgba(34,211,238,0.5)]"></div>
              ...
              <div className="grid gap-8 md:grid-cols-2 mb-12 md:mb-16">
                {events.map((event, index) => (
                  <div
                    key={event.title}
                    className="relative bg-[#1E293B]/60 border border-zinc-700/50 rounded-2xl p-8 hover:shadow-xl hover:shadow-violet-500/10 hover:border-violet-500/30 transition-all duration-300 overflow-hidden group backdrop-blur-md"
                    style={{
                  ...
                  >
                    ...
                    <div className="absolute inset-0 overflow-hidden pointer-events-none rounded-2xl" style={{ transform: 'translate3d(0, 0, 0)' }}>
                      ...
                      <div className="absolute -top-20 -right-20 w-[250px] h-[250px] md:w-[300px] md:h-[300px] bg-gradient-to-bl from-emerald-600/10 via-emerald-600/5 to-transparent rounded-full mix-blend-screen filter blur-2xl md:blur-3xl opacity-0 group-hover:opacity-100 transition-opacity duration-500" style={{ transform: 'translate3d(0, 0, 0)' }} />
                    </div>

                    <div className="relative z-10">
                      <div className="flex items-start justify-between mb-6">
                        <div className="flex-1">
                          <div className="inline-flex items-center px-3 py-1 bg-zinc-800 text-emerald-400 rounded-lg text-sm font-semibold mb-4 border border-zinc-700">
                            {event.date}
                          </div>
                          <h3 className="text-2xl font-display font-bold text-white mb-4 leading-tight group-hover:text-emerald-400 transition-colors duration-300">
                            {event.title}
                          </h3>
                        </div>
                        <div className="ml-4 flex-shrink-0">
                          <div className="relative">
                            <div className="absolute inset-0 bg-gradient-to-r from-violet-500 to-emerald-500 rounded-full blur-md opacity-20 group-hover:opacity-40 transition-opacity duration-300"></div>
                            <div className="relative text-sm text-white bg-zinc-800 border border-zinc-700 px-5 py-2.5 rounded-full font-bold shadow-lg group-hover:border-violet-500/50 transition-colors duration-200">
                              Week {index + 1}
                            </div>
                          </div>
                        </div>
                      </div>
                      <p className="text-zinc-400 leading-relaxed text-base">{event.desc}</p>
                    </div>
                  </div>
                ))}
              </div>
              ...
              <div className="text-center mb-12 md:mb-16">
                <button
                  ...
                  className="group relative inline-flex items-center px-10 py-5 bg-gradient-to-r from-violet-600 via-purple-600 to-emerald-600 hover:from-violet-500 hover:via-purple-500 hover:to-emerald-500 text-white rounded-2xl font-bold text-lg transition-all duration-300 focus:outline-none focus:ring-4 focus:ring-violet-500/30 hover:shadow-2xl hover:shadow-violet-500/25 active:scale-[0.98] overflow-hidden"
                >
          ...
          <section className="relative pt-12 md:pt-16 pb-16 md:pb-24 border-t border-zinc-700/50 bg-[#09090b]">
            ...
            <div className="absolute inset-0 overflow-hidden pointer-events-none" style={{ transform: 'translate3d(0, 0, 0)' }}>
              ...
              <div className="absolute bottom-0 right-1/4 w-[400px] h-[400px] md:w-[500px] md:h-[500px] bg-gradient-to-tl from-emerald-600/10 via-emerald-600/5 to-transparent rounded-full mix-blend-screen filter blur-3xl opacity-30" style={{ transform: 'translate3d(0, 0, 0)' }} />
            </div>

            <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
              <div className="text-center mb-16">
                <div className="inline-block mb-4">
                  <span className="inline-flex items-center px-4 py-2 bg-zinc-800/80 text-violet-400 rounded-full text-sm font-semibold border border-zinc-700">
                    <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div className="mt-6 flex items-center justify-center gap-2 text-zinc-500">
                  ...
                  <span className="text-sm font-semibold text-zinc-400">{eventImages.length} Photos</span>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 sm:gap-6">
                {eventImages.map((imagePath, index) => {
                  ...
                  return (
                    <div
                      key={imagePath}
                      className="group relative aspect-square overflow-hidden rounded-xl sm:rounded-2xl bg-[#1E293B] border border-zinc-700/50 cursor-pointer transition-all duration-300 hover:shadow-xl md:hover:shadow-2xl hover:shadow-emerald-500/20 hover:border-emerald-500/40"
        ...
        {selectedImage && (
          ...
          >
            ...
            <button
              onClick={closeLightbox}
              className="absolute top-4 right-4 md:top-8 md:right-8 text-white hover:text-emerald-400 transition-all duration-200 z-10 bg-black/70 rounded-full p-3.5 hover:bg-black/90 hover:scale-110 active:scale-95 border border-white/10 shadow-xl"
            ...
            <button
              ...
              className="absolute left-4 md:left-8 top-1/2 -translate-y-1/2 text-white hover:text-emerald-400 transition-all duration-200 z-10 bg-black/70 rounded-full p-4 hover:bg-black/90 hover:scale-110 active:scale-95 border border-white/10 shadow-xl"
            ...
            <button
              ...
              className="absolute right-4 md:right-8 top-1/2 -translate-y-1/2 text-white hover:text-emerald-400 transition-all duration-200 z-10 bg-black/70 rounded-full p-4 hover:bg-black/90 hover:scale-110 active:scale-95 border border-white/10 shadow-xl"
